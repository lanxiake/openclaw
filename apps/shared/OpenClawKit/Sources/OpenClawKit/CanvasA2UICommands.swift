...
public enum MtBotCanvasA2UICommand: String, Codable, Sendable {
...
public struct MtBotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MtBotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
