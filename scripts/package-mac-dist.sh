...
# Output:
# - dist/MtBot.app
# - dist/MtBot-<version>.zip
# - dist/MtBot-<version>.dmg
...
ZIP="$ROOT_DIR/dist/MtBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/MtBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/MtBot-$VERSION.notary.zip"
