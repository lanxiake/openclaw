## MtBot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_mtbot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm mtbot gateway --port 18789 --verbose
```
