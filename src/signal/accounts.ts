...
export function listSignalAccountIds(cfg: MtBotConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: MtBotConfig): string {
...
function mergeSignalAccountConfig(cfg: MtBotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MtBotConfig): ResolvedSignalAccount[] {
