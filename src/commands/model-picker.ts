...
function resolveConfiguredModelRaw(cfg: MtBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: MtBotConfig): string[] {
...
export function applyPrimaryModel(cfg: MtBotConfig, model: string): MtBotConfig {
...
export function applyModelAllowlist(cfg: MtBotConfig, models: string[]): MtBotConfig {
  const defaults = cfg.agents?.defaults;
