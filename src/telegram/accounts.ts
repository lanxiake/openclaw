...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MTBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: MtBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: MtBotConfig): string {
...
function mergeTelegramAccountConfig(cfg: MtBotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: MtBotConfig): ResolvedTelegramAccount[] {
