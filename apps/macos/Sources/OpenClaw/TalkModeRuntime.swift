...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.yunkun.mtbot", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.yunkun.mtbot", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MtBotChatMessage] = messages.compactMap { item in
