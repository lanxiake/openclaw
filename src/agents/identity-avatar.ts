...
function resolveAvatarSource(cfg: MtBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MtBotConfig, agentId: string): AgentAvatarResolution {
