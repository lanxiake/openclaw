...
actor RemoteTunnelManager {
    ...
    private let logger = Logger(subsystem: "com.yunkun.mtbot", category: "remote-tunnel")
    ...
    func controlTunnelPortIfRunning() async -> UInt16? {
        ...
        // If a previous MtBot run already has an SSH listener on the expected port (common after restarts),
