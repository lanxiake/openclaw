...
MtBot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.mtbot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["mtbot", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
