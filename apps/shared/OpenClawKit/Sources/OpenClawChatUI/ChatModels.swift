...
public typealias MtBotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MtBotPlatformImage = UIImage
#endif

public struct MtBotChatUsageCost: Codable, Hashable, Sendable {
...
public struct MtBotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MtBotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MtBotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MtBotChatMessageContent: Codable, Hashable, Sendable {
...
public struct MtBotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MtBotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MtBotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MtBotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MtBotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MtBotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MtBotChatMessageContent].self, forKey: .content) {
...
public struct MtBotChatHistoryPayload: Codable, Sendable {
...
public struct MtBotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MtBotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MtBotSessionPreviewItem]
}

public struct MtBotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MtBotSessionPreviewEntry]

    public init(ts: Int, previews: [MtBotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MtBotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MtBotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MtBotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MtBotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MtBotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MtBotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MtBotPlatformImage?
...
public struct MtBotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
