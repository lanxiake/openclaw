...
const ensureMtBotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveMtBotAgentDir = vi.fn().mockReturnValue("/tmp/mtbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/mtbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureMtBotModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveMtBotAgentDir,
}));
