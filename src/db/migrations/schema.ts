...
export const loginAttempts = pgTable(
  ...
  (table) => [
    ...
    index("idx_login_attempts_phone_hash").using(
      "btree",
...
export const skills = pgTable(
  ...
  (table) => [unique("skills_code_key").on(table.code)],
);
...
export const plans = pgTable(
  ...
  (table) => [unique("plans_code_key").on(table.code)],
);
...
export const paymentOrders = pgTable(
  ...
  (table) => [
    index("idx_payment_orders_order_no").using(
      "btree",
      table.orderNo.asc().nullsLast().op("text_ops"),
    ),
    index("idx_payment_orders_user_id").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const couponCodes = pgTable(
  ...
  (table) => [unique("coupon_codes_code_key").on(table.code)],
);
...
export const adminSessions = pgTable(
  ...
  (table) => [
    index("idx_admin_sessions_admin_id").using(
      "btree",
...
export const adminAuditLogs = pgTable(
  ...
  (table) => [
    index("idx_admin_audit_logs_admin_id").using(
      "btree",
      table.adminId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_admin_audit_logs_created_at").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    foreignKey({
...
export const skillStoreItems = pgTable(
  ...
  (table) => [
    index("idx_skill_store_items_author_id").using(
      "btree",
      table.authorId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_skill_store_items_category_id").using(
      "btree",
      table.categoryId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_skill_store_items_created_at").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    index("idx_skill_store_items_download_count").using(
      "btree",
      table.downloadCount.asc().nullsLast().op("int4_ops"),
    ),
    index("idx_skill_store_items_is_featured").using(
      "btree",
      table.isFeatured.asc().nullsLast().op("int4_ops"),
      table.featuredOrder.asc().nullsLast().op("int4_ops"),
    ),
    index("idx_skill_store_items_rating_avg").using(
      "btree",
      table.ratingAvg.asc().nullsLast().op("numeric_ops"),
    ),
    index("idx_skill_store_items_status").using(
      "btree",
      table.status.asc().nullsLast().op("text_ops"),
    ),
    index("idx_skill_store_items_subscription_level").using(
      "btree",
      table.subscriptionLevel.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const skillCategories = pgTable(
  ...
  (table) => [
    index("idx_skill_categories_is_active").using(
      "btree",
      table.isActive.asc().nullsLast().op("bool_ops"),
    ),
    index("idx_skill_categories_sort_order").using(
      "btree",
...
export const skillReviews = pgTable(
  ...
  (table) => [
    ...
    index("idx_skill_reviews_skill_id").using(
      "btree",
      table.skillId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_skill_reviews_user_id").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const userInstalledSkills = pgTable(
  ...
  (table) => [
    index("idx_user_installed_skills_skill_item_id").using(
      "btree",
      table.skillItemId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_user_installed_skills_user_id").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const systemConfigs = pgTable(
  ...
  (table) => [
    ...
    index("idx_system_configs_is_sensitive").using(
      "btree",
      table.isSensitive.asc().nullsLast().op("bool_ops"),
    ),
...
export const configChangeHistory = pgTable(
  ...
  (table) => [
    index("idx_config_change_history_change_type").using(
      "btree",
      table.changeType.asc().nullsLast().op("text_ops"),
    ),
    index("idx_config_change_history_changed_at").using(
      "btree",
      table.changedAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    index("idx_config_change_history_changed_by").using(
      "btree",
      table.changedBy.asc().nullsLast().op("text_ops"),
    ),
    index("idx_config_change_history_config_id").using(
      "btree",
      table.configId.asc().nullsLast().op("text_ops"),
    ),
    index("idx_config_change_history_config_key").using(
      "btree",
