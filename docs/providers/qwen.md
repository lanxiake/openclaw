---
summary: "Use Qwen OAuth (free tier) in MtBot"
read_when:
  - You want to use Qwen with MtBot
...
```bash
mtbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, MtBot will sync credentials
