...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.mtbot.top/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("mtbot hooks list")}`,
      `  ${formatCliCommand("mtbot hooks enable <name>")}`,
      `  ${formatCliCommand("mtbot hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
