...
MtBot. All clients (CLI, web UI, macOS app, iOS/Android nodes, headless
...
- If `MTBOT_GATEWAY_TOKEN` (or `--token`) is set, `connect.params.auth.token`
