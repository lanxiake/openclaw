...
@MainActor
public struct MtBotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MtBotChatViewModel
    ...
    private var visibleMessages: [MtBotChatMessage] {
        let base: [MtBotChatMessage]
    ...
    private func mergeToolResults(in messages: [MtBotChatMessage]) -> [MtBotChatMessage] {
    ...
    private func isToolResultMessage(_ message: MtBotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: MtBotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MtBotChatMessage) -> String {
