...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@mtbot", { botUsername: "mtbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@mtbot args", {
        botUsername: "mtbot",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "mtbot" })).toBe(
      "/help@otherbot",
    );
  });
