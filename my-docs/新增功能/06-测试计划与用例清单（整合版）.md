...
> 版本: 2.9 | 创建日期: 2026-02-08 | 更新日期: 2026-02-11 | 状态: 执行中
>
...
**最后更新**: 2026-02-11 14:00

| 指标            | 数值                    |
| --------------- | ----------------------- |
| 已完成测试文件  | 10 + 33(unit) + 21(e2e) + 7(browser) = 71 |
| 已通过测试用例  | 214 + 209 + 112 + 61 = 596 |
| 失败测试用例    | 0                           |
...
**浏览器测试**: ✅ admin-console 认证 (5/5) ✅ admin-console 用户管理 (5/5) ✅ admin-console 订阅+Gateway (8/8) ✅ admin-console P1 (10/10) ✅ admin-console P2 (11/11) ✅ web-admin 全量 (17/17) ✅ web-admin P1 (5/5)
