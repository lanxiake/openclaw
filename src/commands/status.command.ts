...
export async function statusCommand(
  ...
  runtime.log(theme.heading("MtBot status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("mtbot security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("mtbot security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.mtbot.top/faq");
  runtime.log("Troubleshooting: https://docs.mtbot.top/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("mtbot status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("mtbot logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("mtbot status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("mtbot gateway probe")}`);
  }
}
