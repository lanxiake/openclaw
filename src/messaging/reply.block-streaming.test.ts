...
type RunEmbeddedPiAgent = typeof import("../agent/runtime/pi-embedded.js").runEmbeddedPiAgent;
...
vi.mock("/src/agent/pi-embedded.js", () => piEmbeddedMock);
vi.mock("../agent/pi-embedded.js", () => piEmbeddedMock);
