...
read_when:
  - Setting up Zalo Personal for MtBot
...
- Install via CLI: `mtbot plugins install @mtbot/zalouser`
- Or from a source checkout: `mtbot plugins install ./extensions/zalouser`
...
- `mtbot pairing list zalouser`
- `mtbot pairing approve zalouser <code>`
...
- On startup, MtBot resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `mtbot channels logout --channel zalouser && mtbot channels login --channel zalouser`
