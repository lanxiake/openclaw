  ...
  describe('registerProvider', () => {
    it('应该成功注册提供者', () => {
      class TestProvider implements IWorkingMemoryProvider {
        ...
        async createSession() { return 'test-session' }
        async getSession() { return null }
        async updateSession() {}
        async deleteSession() {}
        async listSessions() { return [] }
        async addMessage() { return 'test-msg' }
        async getMessages() { return [] }
        async getContextWindow() { return [] }
        async setVariable() {}
        async getVariable() { return undefined }
        async clearVariables() {}
        async addToolState() {}
        async updateToolState() {}
        async getToolStates() { return [] }
        async addPendingConfirm() { return 'test-confirm' }
        async resolvePendingConfirm() {}
        async getPendingConfirms() { return [] }
      }
    ...
    it('应该覆盖已存在的提供者', () => {
      class TestProvider1 implements IWorkingMemoryProvider {
        ...
        async createSession() { return 'v1' }
        async getSession() { return null }
        async updateSession() {}
        async deleteSession() {}
        async listSessions() { return [] }
        async addMessage() { return 'v1' }
        async getMessages() { return [] }
        async getContextWindow() { return [] }
        async setVariable() {}
        async getVariable() { return undefined }
        ...
        async updateToolState() {}
        async getToolStates() { return [] }
        async addPendingConfirm() { return 'v1' }
        async resolvePendingConfirm() {}
        async getPendingConfirms() { return [] }
      }
      ...
      class TestProvider2 implements IWorkingMemoryProvider {
        ...
        async createSession() { return 'v2' }
        async getSession() { return null }
        async updateSession() {}
        async deleteSession() {}
        async listSessions() { return [] }
        async addMessage() { return 'v2' }
        async getMessages() { return [] }
        async getContextWindow() { return [] }
        async setVariable() {}
        async getVariable() { return undefined }
        ...
        async updateToolState() {}
        async getToolStates() { return [] }
        async addPendingConfirm() { return 'v2' }
        async resolvePendingConfirm() {}
        async getPendingConfirms() { return [] }
      }
  ...
  describe('对话历史', () => {
    it('应该添加对话并生成摘要', async () => {
      ...
      const messages = [
        ...
        { id: '2', role: 'assistant' as const, content: '很好！你喜欢什么编程语言？', timestamp: new Date() },
      ]
...
describe('工厂快捷方法', () => {
  ...
  it('应该创建对象存储提供者', () => {
    const provider = createObjectStorageProvider({ provider: 'local', options: { basePath: './.test' } })
