...
describe("createMtBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createMtBotCodingTools({
      config,
    ...
    const anthropicTools = createMtBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createMtBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createMtBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
