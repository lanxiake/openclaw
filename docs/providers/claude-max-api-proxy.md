...
You can point MtBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or MtBot
...
- [Anthropic provider](/providers/anthropic) - Native MtBot integration with Claude setup-token or API keys
