# MtBot AI 个人助理平台 - 管理系统设计

> 版本: 2.0 | 创建日期: 2026-02-16 | 状态: 整合版
>
> 本文档整合自原 04a-用户端管理面板设计(web-admin).md、04b-服务端管理后台设计(admin-console).md
...
| 版本 | 日期       | 修订内容                                    |
| ---- | ---------- | ------------------------------------------- |
| 2.0  | 2026-02-16 | 整合 web-admin 与 admin-console 设计文档    |
| 1.0  | 2026-02-12 | 从 04-管理后台系统设计.md 拆分为 04a 和 04b |

---

# 第一部分:用户端管理面板 (web-admin)
