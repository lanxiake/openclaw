...
export const DEFAULT_LOG_DIR = "/tmp/mtbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "mtbot.log"); // legacy single-file path
...
function resolveSettings(): ResolvedSettings {
  let cfg: MtBotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => MtBotConfig;
      };
