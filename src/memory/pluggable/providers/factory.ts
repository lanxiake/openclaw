 ...
 * 记忆类型
 */
export type MemoryType = "episodic" | "profile" | "knowledge";
 ...
 * @example
 * ```typescript
 * registerProvider('episodic', 'mem0', Mem0EpisodicMemoryProvider)
 * registerProvider('knowledge', 'graphiti', GraphitiKnowledgeProvider)
 * ```
 */
