...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: MtBotConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: MtBotConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: MtBotConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: MtBotConfig): void {
