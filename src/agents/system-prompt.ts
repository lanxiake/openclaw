...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "Use TodoWrite ONLY for complex multi-step tasks (3+ steps like coding projects, research reports).",
    "Do NOT use TodoWrite for: simple Q&A, greetings, single searches, translations, short answers.",
    "When you do use it:",
