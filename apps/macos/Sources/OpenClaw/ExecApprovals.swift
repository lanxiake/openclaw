...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "com.yunkun.mtbot", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        MtBotPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        MtBotPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
