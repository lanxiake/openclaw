...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.yunkun.mtbot", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MtBotConfigFile.defaultWorkspaceURL() }
