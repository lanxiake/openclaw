...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (MtBot token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: MtBotOAuthStore.AnthropicOAuthStatus = MtBotOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "com.yunkun.mtbot", category: "anthropic-oauth")
...
enum MtBotOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let mtbotOAuthDirEnv = "MTBOT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "MtBot OAuth token file not found"
            case .unreadableFile: "MtBot OAuth token file not readable"
            case .invalidJSON: "MtBot OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in MtBot OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "MtBot OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.mtbotOAuthDirEnv]?
        ...
        let preferred = home.appendingPathComponent(".mtbot", isDirectory: true)
