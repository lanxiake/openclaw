...
show_usage() {
    cat << EOF
clawlog - MtBot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View MtBot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    MtBot logs flow through the macOS unified log (subsystem: com.yunkun.mtbot).
