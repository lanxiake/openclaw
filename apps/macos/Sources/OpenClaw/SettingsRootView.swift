...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .mtbotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MtBotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MtBotPaths.stateDirURL.path
...
extension Notification.Name {
    static let mtbotSelectSettingsTab = Notification.Name("mtbotSelectSettingsTab")
}
