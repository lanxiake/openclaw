...
enum UIStrings {
    static let welcomeTitle = "Welcome to MtBot"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: MtBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: MtBotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g mtbot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MtBotChatViewModel(
