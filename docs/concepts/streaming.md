...
MtBot has two separate “streaming” layers:
...
When block streaming is enabled, MtBot can **merge consecutive block chunks**
...
When draft streaming is active, MtBot disables block streaming for that reply to avoid double-streaming.
