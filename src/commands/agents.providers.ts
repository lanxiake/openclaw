...
function resolveDefaultAccountId(cfg: MtBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: MtBotConfig): boolean {
...
export function summarizeBindings(cfg: MtBotConfig, bindings: AgentBinding[]): string[] {
