...
export function listIMessageAccountIds(cfg: MtBotConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: MtBotConfig): string {
...
function mergeIMessageAccountConfig(cfg: MtBotConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: MtBotConfig): ResolvedIMessageAccount[] {
