...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MtBotConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MtBotConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = MtBotConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/mtbot"
        state.remoteCliPath = ""
        return state
    }
}
