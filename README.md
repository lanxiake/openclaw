# 🦞 MtBot — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/mtbot/mtbot/main/docs/assets/mtbot-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/mtbot/mtbot/main/docs/assets/mtbot-logo-text.png" alt="MtBot" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/mtbot/mtbot/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/mtbot/mtbot/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/mtbot/mtbot/releases"><img src="https://img.shields.io/github/v/release/mtbot/mtbot?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**MtBot** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://mtbot.top) · [Docs](https://docs.mtbot.top) · [DeepWiki](https://deepwiki.com/mtbot/mtbot) · [Getting Started](https://docs.mtbot.top/start/getting-started) · [Updating](https://docs.mtbot.top/install/updating) · [Showcase](https://docs.mtbot.top/start/showcase) · [FAQ](https://docs.mtbot.top/start/faq) · [Wizard](https://docs.mtbot.top/start/wizard) · [Nix](https://github.com/mtbot/nix-clawdbot) · [Docker](https://docs.mtbot.top/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`mtbot onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.mtbot.top/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.mtbot.top/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.mtbot.top/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.mtbot.top/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.mtbot.top/start/getting-started)

```bash
mtbot onboard --install-daemon

mtbot gateway --port 18789 --verbose

# Send a message
mtbot message send --to +1234567890 --message "Hello from MtBot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
mtbot agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.mtbot.top/install/updating) (and run `mtbot doctor`).
...
Switch channels (git + npm): `mtbot update --channel stable|beta|dev`.
Details: [Development channels](https://docs.mtbot.top/install/development-channels).
...
pnpm mtbot onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm mtbot ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `mtbot` binary.

## Security defaults (DM access)

MtBot connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.mtbot.top/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `mtbot pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `mtbot doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.mtbot.top/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.mtbot.top/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.mtbot.top/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.mtbot.top/nodes/voicewake) + [Talk Mode](https://docs.mtbot.top/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.mtbot.top/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.mtbot.top/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.mtbot.top/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.mtbot.top/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.mtbot.top/nodes).
- **[Onboarding](https://docs.mtbot.top/start/wizard) + [skills](https://docs.mtbot.top/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=mtbot/mtbot&type=date&legend=top-left)](https://www.star-history.com/#mtbot/mtbot&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.mtbot.top/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.mtbot.top/web), and [Canvas host](https://docs.mtbot.top/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.mtbot.top/tools/agent-send): gateway, agent, send, [wizard](https://docs.mtbot.top/start/wizard), and [doctor](https://docs.mtbot.top/gateway/doctor).
- [Pi agent runtime](https://docs.mtbot.top/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.mtbot.top/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.mtbot.top/concepts/groups).
- [Media pipeline](https://docs.mtbot.top/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.mtbot.top/nodes/audio).

### Channels

- [Channels](https://docs.mtbot.top/channels): [WhatsApp](https://docs.mtbot.top/channels/whatsapp) (Baileys), [Telegram](https://docs.mtbot.top/channels/telegram) (grammY), [Slack](https://docs.mtbot.top/channels/slack) (Bolt), [Discord](https://docs.mtbot.top/channels/discord) (discord.js), [Google Chat](https://docs.mtbot.top/channels/googlechat) (Chat API), [Signal](https://docs.mtbot.top/channels/signal) (signal-cli), [iMessage](https://docs.mtbot.top/channels/imessage) (imsg), [BlueBubbles](https://docs.mtbot.top/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.mtbot.top/channels/msteams) (extension), [Matrix](https://docs.mtbot.top/channels/matrix) (extension), [Zalo](https://docs.mtbot.top/channels/zalo) (extension), [Zalo Personal](https://docs.mtbot.top/channels/zalouser) (extension), [WebChat](https://docs.mtbot.top/web/webchat).
- [Group routing](https://docs.mtbot.top/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.mtbot.top/channels).

### Apps + nodes

- [macOS app](https://docs.mtbot.top/platforms/macos): menu bar control plane, [Voice Wake](https://docs.mtbot.top/nodes/voicewake)/PTT, [Talk Mode](https://docs.mtbot.top/nodes/talk) overlay, [WebChat](https://docs.mtbot.top/web/webchat), debug tools, [remote gateway](https://docs.mtbot.top/gateway/remote) control.
- [iOS node](https://docs.mtbot.top/platforms/ios): [Canvas](https://docs.mtbot.top/platforms/mac/canvas), [Voice Wake](https://docs.mtbot.top/nodes/voicewake), [Talk Mode](https://docs.mtbot.top/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.mtbot.top/platforms/android): [Canvas](https://docs.mtbot.top/platforms/mac/canvas), [Talk Mode](https://docs.mtbot.top/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.mtbot.top/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.mtbot.top/tools/browser): dedicated mtbot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.mtbot.top/platforms/mac/canvas): [A2UI](https://docs.mtbot.top/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.mtbot.top/nodes): camera snap/clip, screen record, [location.get](https://docs.mtbot.top/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.mtbot.top/automation/cron-jobs); [webhooks](https://docs.mtbot.top/automation/webhook); [Gmail Pub/Sub](https://docs.mtbot.top/automation/gmail-pubsub).
- [Skills platform](https://docs.mtbot.top/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.mtbot.top/concepts/channel-routing), [retry policy](https://docs.mtbot.top/concepts/retry), and [streaming/chunking](https://docs.mtbot.top/concepts/streaming).
- [Presence](https://docs.mtbot.top/concepts/presence), [typing indicators](https://docs.mtbot.top/concepts/typing-indicators), and [usage tracking](https://docs.mtbot.top/concepts/usage-tracking).
- [Models](https://docs.mtbot.top/concepts/models), [model failover](https://docs.mtbot.top/concepts/model-failover), and [session pruning](https://docs.mtbot.top/concepts/session-pruning).
- [Security](https://docs.mtbot.top/gateway/security) and [troubleshooting](https://docs.mtbot.top/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.mtbot.top/web) + [WebChat](https://docs.mtbot.top/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.mtbot.top/gateway/tailscale) or [SSH tunnels](https://docs.mtbot.top/gateway/remote) with token/password auth.
- [Nix mode](https://docs.mtbot.top/install/nix) for declarative config; [Docker](https://docs.mtbot.top/install/docker)-based installs.
- [Doctor](https://docs.mtbot.top/gateway/doctor) migrations, [logging](https://docs.mtbot.top/logging).
...
- **[Gateway WebSocket network](https://docs.mtbot.top/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.mtbot.top/gateway)).
- **[Tailscale exposure](https://docs.mtbot.top/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.mtbot.top/gateway/remote)).
- **[Browser control](https://docs.mtbot.top/tools/browser)** — mtbot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.mtbot.top/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.mtbot.top/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.mtbot.top/nodes/voicewake) + [Talk Mode](https://docs.mtbot.top/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.mtbot.top/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

MtBot can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (MtBot enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.mtbot.top/gateway/tailscale) · [Web surfaces](https://docs.mtbot.top/web)
...
Details: [Remote access](https://docs.mtbot.top/gateway/remote) · [Nodes](https://docs.mtbot.top/nodes) · [Security](https://docs.mtbot.top/gateway/security)
...
Details: [Nodes](https://docs.mtbot.top/nodes) · [macOS app](https://docs.mtbot.top/platforms/macos) · [Gateway protocol](https://docs.mtbot.top/concepts/architecture)
...
Details: [Session tools](https://docs.mtbot.top/concepts/session-tool)
...
- Controlled via `mtbot nodes …`.

Runbook: [iOS connect](https://docs.mtbot.top/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.mtbot.top/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.mtbot/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.mtbot/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.mtbot/mtbot.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.mtbot.top/gateway/configuration)
...
Details: [Security guide](https://docs.mtbot.top/gateway/security) · [Docker + sandboxing](https://docs.mtbot.top/install/docker) · [Sandbox config](https://docs.mtbot.top/gateway/configuration)

### [WhatsApp](https://docs.mtbot.top/channels/whatsapp)

- Link the device: `pnpm mtbot channels login` (stores creds in `~/.mtbot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.mtbot.top/channels/telegram)
...
### [Slack](https://docs.mtbot.top/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.mtbot.top/channels/discord)
...
### [Signal](https://docs.mtbot.top/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.mtbot.top/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.mtbot.top/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.mtbot.top/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.mtbot.top)
- [Read the architecture overview for the gateway + protocol model.](https://docs.mtbot.top/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.mtbot.top/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.mtbot.top/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.mtbot.top/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.mtbot.top/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.mtbot.top/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.mtbot.top/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.mtbot.top/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.mtbot.top/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.mtbot.top/platforms/windows), [Linux](https://docs.mtbot.top/platforms/linux), [macOS](https://docs.mtbot.top/platforms/macos), [iOS](https://docs.mtbot.top/platforms/ios), [Android](https://docs.mtbot.top/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.mtbot.top/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.mtbot.top/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.mtbot.top/gateway/discovery)
- [Bonjour/mDNS](https://docs.mtbot.top/gateway/bonjour)
- [Gateway pairing](https://docs.mtbot.top/gateway/pairing)
- [Remote gateway README](https://docs.mtbot.top/gateway/remote-gateway-readme)
- [Control UI](https://docs.mtbot.top/web/control-ui)
- [Dashboard](https://docs.mtbot.top/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.mtbot.top/gateway/health)
- [Gateway lock](https://docs.mtbot.top/gateway/gateway-lock)
- [Background process](https://docs.mtbot.top/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.mtbot.top/tools/browser-linux-troubleshooting)
- [Logging](https://docs.mtbot.top/logging)

## Deep dives

- [Agent loop](https://docs.mtbot.top/concepts/agent-loop)
- [Presence](https://docs.mtbot.top/concepts/presence)
- [TypeBox schemas](https://docs.mtbot.top/concepts/typebox)
- [RPC adapters](https://docs.mtbot.top/reference/rpc)
- [Queue](https://docs.mtbot.top/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.mtbot.top/tools/skills-config)
- [Default AGENTS](https://docs.mtbot.top/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.mtbot.top/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.mtbot.top/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.mtbot.top/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.mtbot.top/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.mtbot.top/reference/templates/TOOLS)
- [Templates: USER](https://docs.mtbot.top/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.mtbot.top/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.mtbot.top/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.mtbot.top/platforms/mac/voicewake)
- [iOS node](https://docs.mtbot.top/platforms/ios)
- [Android node](https://docs.mtbot.top/platforms/android)
- [Windows (WSL2)](https://docs.mtbot.top/platforms/windows)
- [Linux app](https://docs.mtbot.top/platforms/linux)

## Email hooks (Gmail)

- [docs.mtbot.top/gmail-pubsub](https://docs.mtbot.top/automation/gmail-pubsub)

## Molty

MtBot was built for **Molty**, a space lobster AI assistant. 🦞
by 成都云鲲创想科技有限公司 and the community.

- [mtbot.top](https://mtbot.top)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@mtbot](https://x.com/mtbot)
