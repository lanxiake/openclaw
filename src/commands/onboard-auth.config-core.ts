...
export function applyZaiConfig(cfg: MtBotConfig): MtBotConfig {
...
export function applyOpenrouterProviderConfig(cfg: MtBotConfig): MtBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: MtBotConfig): MtBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: MtBotConfig): MtBotConfig {
...
export function applyOpenrouterConfig(cfg: MtBotConfig): MtBotConfig {
...
export function applyMoonshotProviderConfig(cfg: MtBotConfig): MtBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: MtBotConfig): MtBotConfig {
...
export function applyKimiCodeProviderConfig(cfg: MtBotConfig): MtBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: MtBotConfig): MtBotConfig {
...
export function applySyntheticProviderConfig(cfg: MtBotConfig): MtBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: MtBotConfig): MtBotConfig {
...
export function applyXiaomiProviderConfig(cfg: MtBotConfig): MtBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: MtBotConfig): MtBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: MtBotConfig): MtBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: MtBotConfig): MtBotConfig {
