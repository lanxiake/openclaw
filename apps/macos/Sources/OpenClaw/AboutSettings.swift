...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/mtbot/mtbot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/mtbot/mtbot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://mtbot.top")
            ...
            Text("© 2025 成都云鲲创想科技有限公司 — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "MtBotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "MtBotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MtBotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MtBotGitCommit") as? String) ??
            "unknown"
    }
