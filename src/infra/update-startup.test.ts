...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "mtbot-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveMtBotPackageRoot } = await import("./mtbot-root.js");
    ...
    vi.mocked(resolveMtBotPackageRoot).mockResolvedValue("/opt/mtbot");
