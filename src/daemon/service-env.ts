...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.MTBOT_STATE_DIR;
  const configPath = env.MTBOT_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    MTBOT_PROFILE: profile,
    MTBOT_STATE_DIR: stateDir,
    MTBOT_CONFIG_PATH: configPath,
    MTBOT_GATEWAY_PORT: String(port),
    MTBOT_GATEWAY_TOKEN: token,
    MTBOT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    MTBOT_SYSTEMD_UNIT: systemdUnit,
    MTBOT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    MTBOT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    MTBOT_STATE_DIR: stateDir,
    MTBOT_CONFIG_PATH: configPath,
    MTBOT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    MTBOT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    MTBOT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    MTBOT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    MTBOT_LOG_PREFIX: "node",
    MTBOT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    MTBOT_SERVICE_KIND: NODE_SERVICE_KIND,
    MTBOT_SERVICE_VERSION: VERSION,
  };
}
