...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "com.yunkun.mtbot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".mtbot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.mtbotCommand(
            subcommand: "gateway",
