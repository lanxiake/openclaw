...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @mtbot/voice-call -> voice-call).
...
export function discoverMtBotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".mtbot", "extensions")];
