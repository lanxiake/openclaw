...
export function listSlackAccountIds(cfg: MtBotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: MtBotConfig): string {
...
function mergeSlackAccountConfig(cfg: MtBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MtBotConfig): ResolvedSlackAccount[] {
