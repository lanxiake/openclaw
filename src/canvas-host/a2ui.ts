...
export const A2UI_PATH = "/__mtbot__/a2ui";

export const CANVAS_HOST_PATH = "/__mtbot__/canvas";

export const CANVAS_WS_PATH = "/__mtbot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.mtbotCanvasA2UIAction.postMessage(...)
  // - Android: window.mtbotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["mtbotCanvasA2UIAction"];
  ...
  globalThis.MtBot = globalThis.MtBot ?? {};
  globalThis.MtBot.postMessage = postToNode;
  globalThis.MtBot.sendUserAction = sendUserAction;
  globalThis.mtbotPostMessage = postToNode;
  globalThis.mtbotSendUserAction = sendUserAction;
